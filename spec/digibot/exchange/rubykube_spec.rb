describe Digibot::Exchange::Rubykube do
  ...
  let(:strategy)   { Digibot::Strategy::Copy.new(strategy_config) }
  let(:order)      { Digibot::Order.new('ethusd', 1, 1, :buy) }
  let(:rubykube)   { Digibot::Exchange::Rubykube.new(exchange_config) }
